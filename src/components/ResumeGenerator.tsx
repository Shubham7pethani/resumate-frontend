  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      ...
      {!canGenerate ? (
        ...
        <div className="text-center py-12">
          <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: 'var(--brand-ring)' }}>
          ...
          <button
            ...
            className="btn-brand disabled:bg-gray-400 px-6 py-3 rounded-md font-medium"
          >
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <button
              ...
              disabled={generating}
              className="flex-1 btn-brand disabled:bg-gray-400 px-6 py-3 rounded-md font-medium flex items-center justify-center"
            >
              {generating ? (
                <>
